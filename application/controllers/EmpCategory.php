...
class EmpCategory extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->model = new EmpCategoryModel();
    }
    ...
    function addEmpCategory(){
        ...
        echo $this->model->insertEmpCategory($data);
    }
    ...
    function getEmpCategories(){
        ...
        echo json_encode($this->model->getEmpCategories($sort_field, $sort_order_mode, $filter_field, $filter_value, $page, $page_size));
    }
