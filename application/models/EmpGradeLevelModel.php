...
/**
 * Description of EmpGradeLevelModel
 *
 * @author Adeleke Oladapo
 */
class EmpGradeLevelModel extends CI_Model {
    ...
    function getEmpGradeLevels($sort_field = false, $sort_order_mode = false, $filter_field = false, $filter_value = false, $page = false, $page_size = false){ 
        $this->db->select('*');
